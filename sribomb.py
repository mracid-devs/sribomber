...
if cho==1:
	...
	print(bar+'\n')
	time.sleep(0.5)
	print(f'\t{Style.BRIGHT}Use this tool at your own risk ! \n\t     https://t.me/cvxovm ' )
	print(bar+'\n')
	...
	print(bar+'\n')
	print("""
This Aplication developed by Mr.Acid
[*] Authentication & all rights at (https://t.me/cvxovm)
A Product By Mr.Acid(https://t.me/cvxovm)
""")
